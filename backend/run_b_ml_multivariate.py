...
if __name__ == "__main__":
    ...
    print("[runner] ===== Georgia B·ML (multivariate) runner =====")
    ...
    print("[runner] START pipeline for target='%s' cadence=%s horizon=%s (multivariate)" % (cfg.target, cfg.cadence, cfg.horizon))
    run_pipeline_ml(cfg)
    print("[runner] DONE")
