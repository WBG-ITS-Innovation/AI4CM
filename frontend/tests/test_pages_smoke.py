...
PAGES = [
    ...
    FRONTEND / "pages" / "01_Start_here.py",
    FRONTEND / "pages" / "08_Scorecard.py",
    FRONTEND / "pages" / "02_Data_Preprocessing.py",
    FRONTEND / "pages" / "03_Lab.py",
    FRONTEND / "pages" / "04_Dashboard.py",
    FRONTEND / "pages" / "06_History.py",
    FRONTEND / "pages" / "09_Documentation.py",
...
def test_withheld_verdict_is_visible_on_the_forecast_page():
    ...
    """
    at = _run(FRONTEND / "pages" / "07_Forecast.py")
    _assert_clean(at, FRONTEND / "pages" / "07_Forecast.py", "repository artifacts")
    blob = " ".join(
